...
public class Vector2D {
	...
	// Devuelve la longitud del vector desde el origen hasta el extremo
	...
	// crea un nuevo objeto con la suma de los dos vectores
	public Vector2D plus(Vector2D that) {
		return new Vector2D(_x + that._x, _y + that._y);
	}

	// crea un nuevo vector y devuelve la resta de los dos vectores
